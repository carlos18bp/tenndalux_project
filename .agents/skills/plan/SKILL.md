---
name: plan
description: "Create a decision-complete implementation plan for a Tenndalux change. Use when the user asks to plan, design, scope, or compare approaches before coding."
...
4. Prefer existing Tenndalux conventions over generic framework patterns.
