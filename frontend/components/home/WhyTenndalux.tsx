...
export default function WhyTenndalux() {
  ...
  return (
    <>
      <section ref={sectionRef} className="py-36 md:py-48 bg-stone-900 text-white overflow-hidden">
          ...
          <div className="grid lg:grid-cols-2 gap-16 lg:gap-24 items-center">
            ...
            <div ref={contentRef} className="space-y-16">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-4 bg-white text-stone-900 px-12 py-6 rounded-full font-bold text-lg hover:bg-stone-100 transition-all duration-300 shadow-xl"
              >
