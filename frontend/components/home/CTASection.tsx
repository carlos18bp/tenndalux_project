...
export default function CTASection() {
  ...
  useEffect(() => {
    const ctx = gsap.context(() => {
      // Apple-style blur reveal with scale
      gsap.fromTo(contentRef.current,
        { opacity: 0, y: 70, scale: 0.93, filter: 'blur(18px)' },
        {
    ...
    <section ref={sectionRef} className="relative py-20 md:py-36 overflow-hidden bg-stone-900">
      ...
      <div ref={contentRef} className="relative max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12 text-center">
        ...
        <p className="text-xl md:text-2xl text-stone-300 mb-14 max-w-3xl mx-auto font-light leading-relaxed">
          Agenda una asesoría sin costo. Análisis técnico del espacio, recomendación estética y funcional, y selección de tejidos y sistemas.
        </p>
