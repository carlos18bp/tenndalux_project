    ...
    <section ref={sectionRef} className="py-36 md:py-48 bg-white">
      <div className="max-w-[1200px] mx-auto px-6 sm:px-8 lg:px-12">
        ...
        <div ref={tableRef} className="overflow-x-auto">
          <div className="min-w-[800px] overflow-hidden rounded-[2rem] border-2 border-stone-200 bg-white shadow-[0_30px_80px_rgba(0,0,0,0.1)]">
            <div className="grid grid-cols-3 bg-stone-50 px-10 py-10 border-b border-stone-200">
              ...
              <div className="col-span-1 text-center relative">
                <div className="absolute -top-10 left-1/2 -translate-x-1/2 bg-stone-900 text-stone-50 text-sm font-semibold px-5 py-2 rounded-full shadow-lg">
                  Recomendado
                </div>
            ...
            <div className="p-14 bg-stone-50/50 text-center border-t border-stone-100">
              ...
              <a
                ...
                className="inline-flex items-center justify-center gap-3 px-12 py-5 border border-transparent text-lg font-bold rounded-full text-white bg-stone-900 hover:bg-stone-800 transition-all duration-300 shadow-xl hover:shadow-2xl"
              >
