...
export default function WhatsAppButton() {
  return (
    <a
      ...
      className="fixed z-50 bottom-6 right-6 w-14 h-14 rounded-full bg-green-500 
                flex items-center justify-center 
                shadow-[0_0_20px_5px_rgba(34,197,94,0.5)]
                cursor-pointer transition-all duration-300 hover:scale-110 hover:shadow-[0_0_25px_8px_rgba(34,197,94,0.6)]"
    ...
    >
      ...
      <span className="sr-only">Chatea con nosotros por WhatsApp</span>
    </a>
  );
}
