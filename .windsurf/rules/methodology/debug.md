...
- Understand architecture using <ANALYZE CODE> (defined in [implement.md](mdc:.windsurf/rules/methodology/implement.md) ) relevant to the issue.
...
- Start modifying code to update and fix things using <SYSTEMATIC CODE PROTOCOL> and <TESTING> (both defined in [implement.md](mdc:.windsurf/rules/methodology/implement.md) ).
