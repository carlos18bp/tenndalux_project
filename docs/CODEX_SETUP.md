...
| Claude Code compatibility | `CLAUDE.md`, `.claude/` | Shared guidance for Claude Code |
...
1. Open Codex at `/home/ryzepeck/webapps/tenndalux_project`.
